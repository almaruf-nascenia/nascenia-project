...
class DevelopersControllerTest < ActionController::TestCase
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post :create, developer: { designation: @developer.designation, joining_date: @developer.joining_date, name: @developer.name, previous_job_exp: @developer.previous_job_exp }
    end
  ...
  test "should update developer" do
    patch :update, id: @developer, developer: { designation: @developer.designation, joining_date: @developer.joining_date, name: @developer.name, previous_job_exp: @developer.previous_job_exp }
    assert_redirected_to developer_path(assigns(:developer))
  end
